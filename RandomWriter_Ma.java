...
/**
   Writes random text with character frequencies and location based on a given text file.
*/
public class RandomWriter_Ma
{
   ...
   private static final int WIGGLE_ROOM = 150; //The number of excessive chars allowed in order to end the generated text on a period rather than cutting it off mid-sentence.
   ...
   */
   public static void main(String[] args)
   {
      ...
      System.out.println("What is the text file you'd like to emulate? (e.g. 'TomSawyer.txt' or 'Constitution.txt')");
      ...
      System.out.println("What is the level of analysis you'd like? (Suggested: 1-15) [Higher levels of analysis means more coherence but less randomness]");
      ...
      for(int i=0; (i<genLength || nextChar!='.') && (i<genLength+WIGGLE_ROOM); i++)
      {
